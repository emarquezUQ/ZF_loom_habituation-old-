...
for i=1:length(RegionList)
    ...
    ratioperRegion(:,i)=sum(ismember(PerBrainRegions_f20.(strcat('reg',num2str(i))).idx,temp_idx))/sum(ismember(PerBrainRegions_f20.(strcat('reg',num2str(i))).idx,temp_idx_fish)); %%length(temp_idx)  %% the formula as it is is redundant cause i get the same value with temp_idx and the divider formula
end
...
for i=1:length(RegionList)
    ...
    ratioperRegion(:,i)=sum(ismember(PerBrainRegions_f60.(strcat('reg',num2str(i))).idx,temp_idx))/sum(ismember(PerBrainRegions_f60.(strcat('reg',num2str(i))).idx,temp_idx_fish)); %%length(temp_idx)
end
...
for i=1:length(RegionList)
    ...
    ratioperRegion(:,i)=sum(ismember(PerBrainRegions_s20.(strcat('reg',num2str(i))).idx,temp_idx))/sum(ismember(PerBrainRegions_s20.(strcat('reg',num2str(i))).idx,temp_idx_fish)); %% length(temp_idx)
end
...
for i=1:length(RegionList)
    ...
    ratioperRegion(:,i)=sum(ismember(PerBrainRegions_s60.(strcat('reg',num2str(i))).idx,temp_idx))/sum(ismember(PerBrainRegions_s60.(strcat('reg',num2str(i))).idx,temp_idx_fish)); %%length(temp_idx)
end
...
save('All_Prop_CL4_per_fish_BrainROIs_perCluster2_extraRestOfBrain.mat','All_Prop_CL4_per_fish');
