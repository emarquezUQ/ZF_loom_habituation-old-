...
%%% this is the same script but for the CL4 data
...
for clust=4
figure;
for i=1:size(Means_CL4_per_fish_s20{1,1},1)
   plot(Means_CL4_per_fish_s20{1,clust}(i,:)); 
    hold on;
end

figure;plot(nanmean(Means_CL4_per_fish_s20{1,clust}))
...
for k=1:30
   ...
   temp_Max_resp(1,k)= min(Means_CL4_per_fish_s20{1,clust}(i,loom_moments{1,k}))-max(Means_CL4_per_fish_s20{1,clust}(i,Loomf20_onset_idx(k)+1));
end
