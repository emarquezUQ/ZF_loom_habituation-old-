...
saveas(gcf,'200rawclusters_CN_f60_job','jpg');
...
for i=1:4
    ...
    print(Fighandle,strcat('200rawclusters_CN_f60_job_',num2str(i)),'-dpng','-r0');
    close all;
end

 
 save('f60_postKmeans_CN_200CL_job.mat','-v7.3');