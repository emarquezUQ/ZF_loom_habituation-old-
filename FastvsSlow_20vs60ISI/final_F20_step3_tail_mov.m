...
%%% To get the ROIs of of the movements 
    ...
    filename=strcat('__Coords_Tail_mov_f20_','.csv');
...
figure;
scatter3(ROI_temp2(idx_rsq_test_f20short,1),ROI_temp2(idx_rsq_test_f20short,2),ROI_temp2(idx_rsq_test_f20short,3)); %%% this is my rotation
hold on;
scatter3(ROI_temp2(idx_rsq_Mov,1),ROI_temp2(idx_rsq_Mov,2),ROI_temp2(idx_rsq_Mov,3)); %%% this is my rotation


figure;
scatter(ROI_temp2(idx_rsq_test_f20short,1),ROI_temp2(idx_rsq_test_f20short,2),'.'); %%% this is my rotation
hold on;
scatter(ROI_temp2(idx_rsq_Mov3,1),ROI_temp2(idx_rsq_Mov3,2),'.'); %%% this is my rotation


figure;
scatter(ROI_temp2(intersect(find(idx_Fish_f20==1),idx_rsq_test_f20short),1),ROI_temp2(intersect(find(idx_Fish_f20==1),idx_rsq_test_f20short),2),'.'); %%% this is my rotation
hold on;
scatter(ROI_temp2(intersect(find(idx_Fish_f20==1),idx_rsq_Mov),1),ROI_temp2(intersect(find(idx_Fish_f20==1),idx_rsq_Mov),2),'.'); %%% this is my rotation


idx_temp1=idx_rsq_test_f20short(find(High_corr_Nb_f20_short==1));
idx_temp2=idx_rsq_test_f20short(find(High_corr_Nb_f20_short==2));

figure;
scatter3(ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f20short),1),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f20short),2),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f20short),3),'.'); %%% this is my rotation
hold on;
...
hold on;
scatter3(ROI_temp2(intersect(PerBrainRegions.Subpallium.idx,idx_rsq_test_f20short),1),ROI_temp2(intersect(PerBrainRegions.Subpallium.idx,idx_rsq_test_f20short),2),ROI_temp2(intersect(PerBrainRegions.Subpallium.idx,idx_rsq_test_f20short),3),'.'); %%% this is my rotation
hold on;
...
figure; 
%scatter3(ROI_temp2(intersect(PerBrainRegions.Telencephalon.idx,idx_rsq_test_f20short),1),ROI_temp2(intersect(PerBrainRegions.Telencephalon.idx,idx_rsq_test_f20short),2),ROI_temp2(intersect(PerBrainRegions.Telencephalon.idx,idx_rsq_test_f20short),3)); %%% this is my rotation
hold on;
     for fish=Fish_with_behav_f20
        if ismember(fish,unique(idx_Fish_f20)) %%isempty(Correlation_movement_post3{fish})~=1 % idx_Fish_f20==Fish_with_behav_f20(fish)
        idx_temp_fish=intersect(find(idx_Fish_f20==fish),idx_rsq_test_f20short);
        idx_temp_nonhab=idx_rsq_test_f20short(find(High_corr_Nb_f20_short==1));
...
figure;imagesc(ZS_f20(intersect(idx_temp1,find(idx_Fish_f20==1)),:));

figure;plot(mean(ZS_f20(intersect(idx_temp1,find(idx_Fish_f20==1)),:)));
...
figure;imagesc(ZS_f20(intersect(idx_temp2,find(idx_Fish_f20==1)),:));
figure;imagesc(ZS_f20(intersect(idx_temp3,find(idx_Fish_f20==1)),:));

figure;plot(mean(ZS_f20(intersect(idx_temp2,find(idx_Fish_f20==1)),:)));
figure;plot(mean(ZS_f20(intersect(idx_temp3,find(idx_Fish_f20==1)),:)));

figure;
scatter3(ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f20short),1),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f20short),2),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f20short),3),'.'); %%% this is my rotation
hold on;
scatter3(ROI_temp2(intersect(idx_temp2,find(idx_Fish_f20==1)),1),ROI_temp2(intersect(idx_temp2,find(idx_Fish_f20==1)),2),ROI_temp2(intersect(idx_temp2,find(idx_Fish_f20==1)),3),'.'); %%% this is my rotation
hold on;
scatter3(ROI_temp2(intersect(idx_temp3,find(idx_Fish_f20==1)),1),ROI_temp2(intersect(idx_temp3,find(idx_Fish_f20==1)),2),ROI_temp2(intersect(idx_temp3,find(idx_Fish_f20==1)),3),'.'); %%% this is my rotation
