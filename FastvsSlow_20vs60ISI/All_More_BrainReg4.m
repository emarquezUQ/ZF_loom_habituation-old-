...
%%%% this script is to collect the idxs of most of brain regions, just to check if I am missing something
%%%% I will exclude the hindbrain cause i have a script just for it (All_More_BrainReg3.m)
...
indx_Rhomb=find(contains(Zbrain_Masks(:,1),'Rhombencephalon')); %% to find the indexes of the Hindbrain
indx_Brain=setdiff(1:1:length(Zbrain_Masks),indx_Rhomb);
...
i=[76,113,128,148];
RegionList(i)=[]; %%% to get rid of the "empty" ones
...
save('All_More_BrainReg4.mat','PerBrainRegions','RegionList','ROI_temp2','-v7.3');
