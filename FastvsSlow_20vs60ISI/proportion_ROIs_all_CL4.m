...
clearvars -except All_Prop_CL4_per_fish clustersS clustersS datasets RegionList
...
save('All_Prop_CL4_per_fish_rsq.mat','All_Prop_CL4_per_fish');
...
All_Prop_CL4_per_fish_rsq=load('All_Prop_CL4_per_fish_rsq.mat');

All_Prop_CL4_per_fish_rsq=All_Prop_CL4_per_fish_rsq.All_Prop_CL4_per_fish;


All_Prop_CL4_per_fish_BrainROIs=load('All_Prop_CL4_per_fish_BrainROIs.mat');

All_Prop_CL4_per_fish_BrainROIs=All_Prop_CL4_per_fish_BrainROIs.All_Prop_CL4_per_fish;
...
subplot(3,3,counter);
for data=1:size(datasets,1)
boxplot(All_Prop_CL4_per_fish_BrainROIs.(datasets(data,:)).(clustersF{clust}),'Colors',colors{data});set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 0.3])
hold on;
end
%boxplot(All_Prop_CL4_per_fish.s20.(clustersF{clust}),'Colors','r');set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 1])
counter=counter+1;
...
subplot(3,3,counter);
for data=1:size(datasets,1)
plot(mean(All_Prop_CL4_per_fish_BrainROIs.(datasets(data,:)).(clustersF{clust})),strcat('.',colors{data}));set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 0.2])
hold on;
end
%boxplot(All_Prop_CL4_per_fish.s20.(clustersF{clust}),'Colors','r');set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 1])
counter=counter+1;
