...
saveas(gcf,'200rawclusters_CN_s20_job','jpg');
...
for i=1:4
    ...
    print(Fighandle,strcat('200rawclusters_CN_s20_job_',num2str(i)),'-dpng','-r0');
    close all;
end

 
 save('s20_postKmeans_CN_200CL_job.mat','-v7.3');