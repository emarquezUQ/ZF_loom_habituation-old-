...
load('final_F60_step1_2.mat','MatFiles','ZS_f60','idx_Fish_f60','idx_Plane_f60','rawregressF60');
...
loomtimes=zeros(1,size(ZS_f60,2)); %%%to mae a 3D array the size of the number of fish (18 at the moment), the type of movement (1) and the lenght of the SPIM movies (depending on the variable). 
...
%%%%first 3 looms. for f60 it would be from 180 onwards
...
for fish= Fish_with_behav_f60
   if ismember(fish,unique(idx_Fish_f60))  
    ...
    %temp_ZS=ZS_f60(find(idx_Fish_f60==fish),:);ModelResults_temp=[];
        ...
        %%% before and after.
        %mdl=fitlm(squeeze(squeeze(Movements(find(Fish_with_behav_f60==fish),find(Movements2(find(Fish_with_behav_f60==fish),:)))))',temp_ZS(i,find(Movements2(find(Fish_with_behav_f60==fish),:))));
...
%%% 0.2 is a good threshold usually but as for s60 the results were not
%%% very good... I tried with 0.15 and 0.1. at the moment i will stay with 0.1. 
...
%%% To get the ROIs of of the movements 
    ...
    filename=strcat('__Coords_Tail_mov_f60_','.csv');
...
figure;
scatter3(ROI_temp2(idx_rsq_test_f60short_3,1),ROI_temp2(idx_rsq_test_f60short_3,2),ROI_temp2(idx_rsq_test_f60short_3,3)); %%% this is my rotation
hold on;
scatter3(ROI_temp2(idx_rsq_Mov,1),ROI_temp2(idx_rsq_Mov,2),ROI_temp2(idx_rsq_Mov,3)); %%% this is my rotation


figure;
scatter(ROI_temp2(idx_rsq_test_f60short3,1),ROI_temp2(idx_rsq_test_f60short3,2),'.'); %%% this is my rotation
hold on;
scatter(ROI_temp2(idx_rsq_Mov,1),ROI_temp2(idx_rsq_Mov,2),'.'); %%% this is my rotation


figure;
scatter(ROI_temp2(intersect(find(idx_Fish_f60==3),idx_rsq_test_f60short_3),1),ROI_temp2(intersect(find(idx_Fish_f60==3),idx_rsq_test_f60short_3),2),'.'); %%% this is my rotation
hold on;
scatter(ROI_temp2(intersect(find(idx_Fish_f60==3),idx_rsq_Mov),1),ROI_temp2(intersect(find(idx_Fish_f60==3),idx_rsq_Mov),2),'.'); %%% this is my rotation


idx_temp1=idx_rsq_test_f60short3(find(High_corr_Nb_f60_short==1));
idx_temp2=idx_rsq_test_f60short3(find(High_corr_Nb_f60_short==2));

figure;
%scatter3(ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f60short),1),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f60short),2),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f60short),3),'.'); %%% this is my rotation
hold on;
...
hold on;
scatter3(ROI_temp2(intersect(PerBrainRegions.Subpallium.idx,idx_rsq_test_f60short3),1),ROI_temp2(intersect(PerBrainRegions.Subpallium.idx,idx_rsq_test_f60short3),2),ROI_temp2(intersect(PerBrainRegions.Subpallium.idx,idx_rsq_test_f60short3),3),'.'); %%% this is my rotation
hold on;
...
figure; 
%scatter3(ROI_temp2(intersect(PerBrainRegions.Telencephalon.idx,idx_rsq_test_f60short_3),1),ROI_temp2(intersect(PerBrainRegions.Telencephalon.idx,idx_rsq_test_f60short_3),2),ROI_temp2(intersect(PerBrainRegions.Telencephalon.idx,idx_rsq_test_f60short_3),3)); %%% this is my rotation
hold on;
     for fish=Fish_with_behav_f60
        if ismember(fish,unique(idx_Fish_f60)) %%isempty(Correlation_movement_post3{fish})~=1 % idx_Fish_f60==Fish_with_behav_f60(fish)
        idx_temp_fish=intersect(find(idx_Fish_f60==fish),idx_rsq_test_f60short3);
        idx_temp_nonhab=idx_rsq_test_f60short3(find(High_corr_Nb_f60_short==1));
...
figure;imagesc(ZS_f60(intersect(idx_temp1,find(idx_Fish_f60==1)),:));

figure;plot(mean(ZS_f60(intersect(idx_temp1,find(idx_Fish_f60==1)),:)));
...
figure;imagesc(ZS_f60(intersect(idx_temp2,find(idx_Fish_f60==1)),:));
figure;imagesc(ZS_f60(intersect(idx_temp3,find(idx_Fish_f60==1)),:));

figure;plot(mean(ZS_f60(intersect(idx_temp2,find(idx_Fish_f60==1)),:)));
figure;plot(mean(ZS_f60(intersect(idx_temp3,find(idx_Fish_f60==1)),:)));

figure;
scatter3(ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f60short_3),1),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f60short_3),2),ROI_temp2(intersect(PerBrainRegions.Pallium.idx,idx_rsq_test_f60short_3),3),'.'); %%% this is my rotation
hold on;
scatter3(ROI_temp2(intersect(idx_temp2,find(idx_Fish_f60==1)),1),ROI_temp2(intersect(idx_temp2,find(idx_Fish_f60==1)),2),ROI_temp2(intersect(idx_temp2,find(idx_Fish_f60==1)),3),'.'); %%% this is my rotation
hold on;
scatter3(ROI_temp2(intersect(idx_temp3,find(idx_Fish_f60==1)),1),ROI_temp2(intersect(idx_temp3,find(idx_Fish_f60==1)),2),ROI_temp2(intersect(idx_temp3,find(idx_Fish_f60==1)),3),'.'); %%% this is my rotation
