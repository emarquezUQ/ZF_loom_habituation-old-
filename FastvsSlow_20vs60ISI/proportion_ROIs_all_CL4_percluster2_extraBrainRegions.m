...
%%%% the CL4 and per cluster. but for more regions than before. In this
%%%% case I am also checking the M1, M2, separating the thalamus in dorsal
%%%% and ventral and I am checking the AF4, AF6 and AF8. The idea was to
%%%% check at possible ascending visual pathways. 

%%%% the results are not very impresive... most relevant is maybe that the
%%%% thalamus has more nonhab and fasthab neurons than M2 (future
%%%% preglomerular). but this could be due to the fact that M2 is very
%%%% ventral and we probably dont get most of it. of the very few neurons
%%%% in M2, it seems that they are mostly Fasthab, which could be
%%%% interesting... although the numbers are very low... 

%%% I could also not corroborate the retina-EmT-habenula pathway
...
for j=1:size(clustersF,1)
    ...
    regionName=regionName(~isspace(regionName))
...
save('All_Prop_CL4_per_fish_rsq_perCluster2_extraBrainRegions.mat','All_Prop_CL4_per_fish');
...
%%% this part I havent change it cause it was to compare other datasets and
%%% as the results dont seem that interesting I dont think it will be worth
%%% it. 
