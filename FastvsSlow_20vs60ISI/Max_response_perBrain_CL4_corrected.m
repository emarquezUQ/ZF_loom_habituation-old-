%%%% this is a corrected version of the max response script where i filter
%%%% for brain regions that have less that 5 ROIs and areas that have less
%%%% that 3 fish. 
...
figure('Position',[100 0 900 900]);
counter=1;
temp_regionClust=intersect(fieldnames(Max_resp_s20_perfishNbrain2.(RegionList{brain})),fieldnames(Max_resp_f60_perfishNbrain2.(RegionList{brain})));
for clust=1:length(temp_regionClust)
subplot(3,3,counter);
...
plot(nanmean(Max_resp_f20_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'b');
else
end
hold on;
if ismember(clustersF{clust},fieldnames(Max_resp_f60_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_f60_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'g');
else
end
hold on;
if ismember(clustersF{clust},fieldnames(Max_resp_s20_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_s20_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'r');
else 
end
hold on;
if ismember(clustersF{clust},fieldnames(Max_resp_s60_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_s60_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'m');
else
end
...
subplot(3,3,counter); 
if ismember(clustersF{clust},fieldnames(Max_resp_f20_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_f20_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'b'); title(RegionList{brain});
else
end
hold on;
if ismember(clustersF{clust},fieldnames(Max_resp_f60_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_f60_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'g'); title(RegionList{brain});
else
end
hold on;
if ismember(clustersF{clust},fieldnames(Max_resp_s20_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_s20_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'r'); title(RegionList{brain});
else
end
hold on;
if ismember(clustersF{clust},fieldnames(Max_resp_s60_perfishNbrain2.(RegionList{brain})))
plot(nanmean(Max_resp_s60_perfishNbrain2.(RegionList{brain}).(clustersF{clust})),'m'); title(RegionList{brain});
else
end
