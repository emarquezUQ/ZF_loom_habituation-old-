...
for i=1:length(fish)
   ...
   subplot(3,3,counter); plot(Prop_CL4_per_fish_f20{clust}(i,:),'.');set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
     
    hold on;
    %subplot(3,3,counter);bar(mean(Prop_CL4_per_fish_f20{clust}));set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
...
subplot(3,3,counter);boxplot(Prop_CL4_per_fish_f20{clust});set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
 counter=counter+1;
...
clearvars -except All_Prop_CL4_per_fish clustersF clustersS datasets RegionList

%%% the box plot is very nice.
counter=1; 
figure;
for clust=1:size(clustersF,1)
subplot(3,3,counter);boxplot(All_Prop_CL4_per_fish.f20.(clustersF{clust}));set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
 counter=counter+1;
end
...
figure;
for clust=1:size(clustersF,1)
subplot(3,3,counter);boxplot(All_Prop_CL4_per_fish.f60.(clustersF{clust}));set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
 counter=counter+1;
end
...
clearvars -except All_Prop_CL4_per_fish clustersS clustersF datasets RegionList

%%% the box plot is very nice.
counter=1; 
figure;
for clust=1:size(clustersS,1)
subplot(3,3,counter);boxplot(All_Prop_CL4_per_fish.s20.(clustersS{clust}));set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersS{clust,1})); ylim([0 .3])
 counter=counter+1;
end
...
figure;
for clust=1:size(clustersS,1)
subplot(3,3,counter);boxplot(All_Prop_CL4_per_fish.s60.(clustersS{clust}));set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersS{clust,1})); ylim([0 .3])
 counter=counter+1;
end

save('All_Prop_CL4_per_fish_BrainROIs.mat','All_Prop_CL4_per_fish');
...
boxplot(All_Prop_CL4_per_fish.(datasets(data,:)).(clustersF{clust}),'Colors',colors{data});set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
hold on;
end
%boxplot(All_Prop_CL4_per_fish.s20.(clustersF{clust}),'Colors','r');set(gca,'xticklabel',RegionList),xtickangle(45),title((clustersF{clust,1})); ylim([0 .3])
counter=counter+1;
end